...
<details>
<summary><b>재방문 의향 예측 — 공공 데이터 23,863건으로 재방문 결정요인을 해석한 분석 (학회 은상)</b></summary>
...
**한계**
만족도 4점 제외로 인한 표본 선택 편향 · 설문 자기응답 기반이므로 실제 행동이 아닌 "의향" 측정 · 3개 권역 외 일반화 불가 · 단면 데이터라 인과 추론 불가
